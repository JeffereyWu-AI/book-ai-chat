...
import Image from 'next/image'  // Next.js 的圖片元件，支援圖片最佳化、lazy loading 等。
import Link from 'next/link'    // Next.js 的連結元件，用來做前端路由切換。

// 一個無狀態的函式型元件（沒有 hooks，只負責 UI）。
const HeroSection = () => {
    return (
        <section className="wrapper mb-10 md:mb-16">
            <div className="library-hero-card">
                <div className="library-hero-content">
                    ...
                    {/* 這種桌機版／手機版分開的寫法，是為了能在不同裝置上有不同 layout 或位置，而不用硬靠一套樣式去調整。 */}
